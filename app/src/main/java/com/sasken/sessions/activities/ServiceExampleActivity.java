...
//    private BoundService mService;
    ...
    class AsyncBackgroundTask extends AsyncTask<Integer, Void, Void> {
        ...
        private CountDownTimer mTicker = new CountDownTimer(120000, 1000) {
            ...
            public void onTick(long l) {
                ...
                LocalBroadcastManager.getInstance(ServiceExampleActivity.this).sendBroadcast(intent);
            }
        ...
        protected void onPostExecute(Void unused) {
            ...
            Toast.makeText(ServiceExampleActivity.this,"Successfully Completed .. ",Toast.LENGTH_SHORT).show();
        }
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            Toast.makeText(ServiceExampleActivity.this,"Just Initiated Count Down Completed .. ",Toast.LENGTH_SHORT).show();
        }
    }
}